...
from ...hand_tracking.input_modes import InputMode, SPARK_BACKEND, validate_ik_input
...
def create_bilateral_backend(name, input_mode, *, required_capability, **worker_options):
    ...
    return SparkWorkerClient(required_capability=required_capability, **worker_options)
