...
from ..sources.common.control_geometry import IK_TCP_TO_HAND_CONTROL_TRANSLATION_M


def horizontal_reference(urdf=None):
    """FK at q=0 (horizontal lateral extension), never a robot command."""
    path = Path(urdf) if urdf else Path(__file__).resolve().parents[2] / 'assets/marvin_m6_ccs/urdf/marvin_m6_s_ccs_696_v4.urdf'
