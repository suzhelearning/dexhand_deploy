...
from tianji_teleop.hand_tracking.pico import parse_pico_packet, PICO_TO_MEDIAPIPE
...
class OfficialPicoInputTest(unittest.TestCase):
    ...
    def convert(self, frame):
        self.assertIsNotNone(importlib.util.find_spec('tianji_teleop.hand_tracking.official_pico'))
    ...
    def test_pinned_official_preparation_is_rigid_invariant_and_not_mirrored(self):
        path = ROOT / 'third_party/wuji_hand_retargeting/wuji_retargeting/mediapipe.py'
